! function(t) {
                ...
                i.makeArray = function(t) { return Array.isArray(t) ? t : null == t ? [] : "object" == typeof t && "number" == typeof t.length ? n.call(t) : [t] }, i.removeFrom = function(t, e) { var i = t.indexOf(e); - 1 != i && t.splice(i, 1) }, i.getParent = function(t, i) {
                    ...
                    return t.forEach((function(t) {
                        if (t instanceof HTMLElement)
                            if (n) { e(t, n) && s.push(t); for (var i = t.querySelectorAll(n), o = 0; o < i.length; o++) s.push(i[o]) } else s.push(t)
                    })), s
    ...
    var n, s;
    ! function(o, r) {
        n = [i(2), i(5), i(0), i(9), i(10), i(11)], void 0 === (s = function(t, e, i, n, s, r) {
            return function(t, e, i, n, s, o, r) {
                ...
                function c(t, e) { for (t = n.makeArray(t); t.length;) e.appendChild(t.shift()) }
                var d = 0,
                    u = {};
                ...
                }, f.watchCSS = function() { this.options.watchCSS && (-1 != h(this.element, ":after").content.indexOf("flickity") ? this.activate() : this.deactivate()) }, f.onkeydown = function(t) {
                ...
                return p.setJQuery = function(t) { a = t }, p.Cell = s, p.Slide = o, p
            }(o, t, e, i, n, s, r)
        }.apply(e, n)) || (t.exports = s)
    }(window)
}, function(t, e, i) {
     ...
     */
    window, s = [i(1), i(12), i(14), i(15), i(16), i(17), i(18)], void 0 === (o = "function" == typeof(n = function(t) { return t }) ? n.apply(e, s) : n) || (t.exports = o)
}, function(t, e, i) {
    var n, s;
    /*!
     * getSize v2.0.3
    ...
    window, void 0 === (s = "function" == typeof(n = function() {
        ...
        function a(e) {
            if (function() {
                ...
                var h = s(e);
                if ("none" == h.display) return function() { for (var t = { width: 0, height: 0, innerWidth: 0, innerHeight: 0, outerWidth: 0, outerHeight: 0 }, e = 0; e < n; e++) t[i[e]] = 0; return t }();
                var l = {};
                ...
                var g = l.paddingLeft + l.paddingRight,
                    ...
                    S = c && o,
                    x = t(h.width);
                !1 !== x && (l.width = x + (S ? 0 : g + b));
                var C = t(h.height);
                return !1 !== C && (l.height = C + (S ? 0 : v + E)), l.innerWidth = l.width - (g + b), l.innerHeight = l.height - (v + E), l.outerWidth = l.width + m, l.outerHeight = l.height + y, l
            }
        }
        return a
    }) ? n.call(e, i, e, t) : n) || (t.exports = s)
    ...
    var s = new Array,
        ...
        r = c(".modal"),
        a = c(".modal-trigger"),
        h = c(".modal-card-head .delete, .modal-card-foot .button, .modal-background");
    ...
    a.length > 0 && a.forEach((function(t) {
        t.addEventListener("click", (function() {
            ! function(t) {
                ...
                o.classList.add("is-clipped"), e.classList.add("is-active");
                var i = t + "-carousel";
                if (document.querySelector("#" + i)) {
                    if (0 === s.length) s.push(l(i));
                    else -1 === s.findIndex(t => t.element.id == i) && s.push(l(i))
                }
            }(t.dataset.target)
        }))
    })), h.length > 0 && h.forEach((function(t) { t.addEventListener("click", (function() { o.classList.remove("is-clipped"), r.forEach((function(t) { t.classList.remove("is-active") })) })) }))
    ...
    var n, s;
    ! function(o, r) {
        n = [i(1), i(13), i(0)], void 0 === (s = function(t, e, i) {
            return function(t, e, i, n) {
                ...
                return s.pointerDownFocus = function(t) { a[t.target.nodeName] || this.focus() }, s._pointerDownPreventDefault = function(t) {
                ...
                }, s._getClosestResting = function(t, e, i) { for (var n = this.selectedIndex, s = 1 / 0, o = this.options.contain && !this.options.wrapAround ? function(t, e) { return t <= e } : function(t, e) { return t < e }; o(e, s) && (n += i, s = e, null !== (e = this.getSlideDistance(-t, n)));) e = Math.abs(e); return { distance: s, index: n - i } }, s.getSlideDistance = function(t, e) {
                    var i = this.slides.length,
    ...
    ! function(o, r) {
        n = [i(3)], void 0 === (s = function(t) {
            return function(t, e) {
                ...
                }, n._touchActionValue = "none", n.pointerDown = function(t, e) { this.okayPointerDown(t) && (this.pointerDownPointer = { pageX: e.pageX, pageY: e.pageY }, t.preventDefault(), this.pointerDownBlur(), this._bindPostStartEvents(t), this.emitEvent("pointerDown", [t, e])) };
     ...
     */
    window, n = [i(4), i(20)], void 0 === (s = function(t, e) {
        return function(t, e, i) {
            "use strict";
